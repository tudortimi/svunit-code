...
def test_sim_3(datafiles, simulator):
    with datafiles.as_cwd():
        ...
        expect_string_esc(br'INFO:  [0][dut_ut]: RUNNING', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: first_test::RUNNING', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: first_test::PASSED', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: second_test::RUNNING', 'run.log')
        expect_string_esc(br'ERROR: [0][dut_ut]: fail_if: 1 (at *dut_unit_test.sv line:66)', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: second_test::FAILED', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: third_test::RUNNING', 'run.log')
        expect_string_esc(br'ERROR: [0][dut_ut]: fail_unless: beam == 1 (at *dut_unit_test.sv line:73)', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: third_test::FAILED', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: fourth_test::RUNNING', 'run.log')
        expect_string_esc(br"ERROR: [0][dut_ut]: fail_if_equal: ('hf) === (15) (at *dut_unit_test.sv line:80)", 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: fourth_test::FAILED', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: fifth_test::RUNNING', 'run.log')
        expect_string_esc(br"ERROR: [0][dut_ut]: fail_unless_equal: (15) !== ('ha) (at *dut_unit_test.sv line:86)", 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: fifth_test::FAILED', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: FAILED', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: sixth_test::RUNNING', 'run.log')
        expect_string_esc(br'ERROR: [0][dut_ut]: fail_unless: bozo == 1 [ bozo is wrong ] (at *dut_unit_test.sv line:93)', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: sixth_test::FAILED', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: seventh_test::RUNNING', 'run.log')
        expect_string_esc(br'ERROR: [0][dut_ut]: fail_if: bozo != 2 [ gum is wrong 4 ] (at *dut_unit_test.sv line:99)', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: seventh_test::FAILED', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: eighth_test::RUNNING', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: eighth_test::PASSED', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: ninth_test::RUNNING', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: ninth_test::PASSED', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: tenth_test::RUNNING', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: tenth_test::PASSED', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: eleventh_test::RUNNING', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: eleventh_test::PASSED', 'run.log')
        expect_string_esc(br'ERROR: [0][dut_ut]: fail_if: foo != 1 (at .*dut_unit_test.sv line:.*)', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: x_as_fail_if_expression::FAILED', 'run.log')
        expect_string_esc(br'INFO:  [0][dut_ut]: warning_print_test::RUNNING', 'run.log')
        expect_string_esc(br'WARNING: [0][dut_ut]: simple warning', 'run.log')
        expect_string_esc(br'INFO:  [0][testrunner]: FAILED', 'run.log')
