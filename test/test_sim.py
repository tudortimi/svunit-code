...
def test_sim_14(datafiles, simulator):
    with datafiles.as_cwd():
        ...
        expect_string_esc(br"ERROR: [0][dut_ut]: fail_if: 1 (at *./dut_unit_test.sv line:46)", 'run.log')
        expect_string_esc(br"ERROR: [0][dut_ut]: fail_if: 1 (at *./dut_unit_test.sv line:69)", 'run.log')
